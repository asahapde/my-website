    ...
    render() {
        return (
            <Container>
                ...
                <h3 className="m-3"><strong>Software Engineering</strong> student at <strong className="uwo">University of Western Ontario</strong></h3>
                <h4 className="m-3">Seeking Summer 2021 Internships</h4>
                <h5 className="m-3"><a href="https://drive.google.com/file/d/1sb80t1MkVx8ZQIFECEAOwEGCxQDSb7HF/view?usp=sharing" target="_blank" className="resume"><strong>RESUME</strong></a></h5>
                <Row className="m-5">
